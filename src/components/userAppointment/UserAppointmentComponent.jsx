...
import {Button, DatePicker, Form, Input, message, Modal, Popconfirm, Radio, Select, Table, Tag} from "antd";
...
* @Author: 张建安
* @Data: 2024/8/26
* @Description：用户预约查询与管理
*
* */
const UserAppointmentComponent = () => {
    ...
    const fetchAppointmentsByIdCard = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${API_BASE_URL}/api/appointments/search/${user.idCard}`);
